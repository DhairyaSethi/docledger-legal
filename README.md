...
# Accord Protocol Template: docledger
...
```
cicero parse --template ./docledger/ --dsl ./docledger/sample.txt
...
```
cicero execute --template ./docledger/ --dsl ./docledger/sample.txt --data ./docledger/data.json 
```
